...
class _SalesPageState extends State<SalesPage> {
  ...
  void _clear() {
    ...
    setState(() {});
            ...
            TextField(
              controller: ct['voriW'], 
              decoration: InputDecoration(labelText: isEnglish ? 'Wages (Per Vori ৳)' : 'ভরি প্রতি মজুরি (৳)'), 
              keyboardType: TextInputType.number
            ),
            TextField(
              controller: ct['fixedW'], 
              decoration: InputDecoration(labelText: isEnglish ? 'Fixed Wages ৳' : 'ফিক্সড মজুরি (৳)'), 
              keyboardType: TextInputType.number
            ),
            TextField(
              controller: ct['totalW'], 
              readOnly: true, 
              decoration: InputDecoration(labelText: isEnglish ? 'Total Wages ৳' : 'মোট মজুরি (৳)')
            ),
            TextField(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            Text(isEnglish ? 'Price Adjust?' : 'দাম বাদ?', style: TextStyle(fontSize: 11)), 
                            Checkbox(
                              value: isOldRateChecked, 
                              onChanged: (v) { setState(() { isOldRateChecked = v!; _calculate(); }); }
                            )
                          ]
                        ),
                      ]
                        ...
                        Row(
                          children: [
                            ...
                            Checkbox(
                              ...
                              onChanged: (v) { setState(() { isPakaRateChecked = v!; _calculate(); }); }
                            )
                          ]
                        ),
                      ]
